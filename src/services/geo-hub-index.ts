...
const GEO_HUBS: GeoHubLocation[] = [
  ...
  },
  {
    ...
    type: "conflict",
    tier: "major",
    keywords: ["sahel", "mali", "niger", "burkina faso", "wagner", "junta"],
  },
  {
    id: "ethiopia",
    name: "Ethiopia",
    ...
    type: "conflict",
    tier: "notable",
    keywords: ["ethiopia", "ethiopian", "tigray", "addis ababa", "abiy ahmed"],
  },
  {
    id: "myanmar",
    name: "Myanmar",
    ...
    type: "conflict",
    tier: "notable",
    keywords: ["myanmar", "burma", "rohingya", "junta", "naypyidaw"],
  },
  ...
  // Strategic Chokepoints & Regions
  {
    ...
    type: "strategic",
    tier: "critical",
    keywords: ["hormuz", "strait of hormuz", "persian gulf", "gulf"],
  },
  {
    id: "redsea",
    name: "Red Sea",
  ...
  },
  {
    ...
    type: "organization",
    tier: "critical",
    keywords: ["nato", "north atlantic", "alliance", "stoltenberg"],
  },
  {
    id: "iaea-vienna",
    name: "IAEA",
...
export function inferGeoHubsFromTitle(title: string): GeoHubMatch[] {
  ...
  for (const [keyword, hubIds] of index.byKeyword) {
    ...
    const regex =
      keyword.length < 5 ? new RegExp(`\\b${keyword}\\b`, "i") : null;

    const found = regex ? regex.test(titleLower) : titleLower.includes(keyword);
