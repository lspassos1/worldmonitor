...
export const US_MILITARY_CALLSIGNS: CallsignPattern[] = [
  ...
  },
  {
    ...
    operator: "usaf",
    aircraftType: "vip",
    description: "Special Air Mission",
  },
  {
    pattern: "^AF[12]",
    operator: "usaf",
    aircraftType: "vip",
    description: "Air Force One/Two",
  },
  {
    pattern: "^EXEC",
    operator: "usaf",
  ...
  },
  {
    ...
    description: "Fighter ops",
  },
  {
    pattern: "^VIPER",
    operator: "usaf",
    aircraftType: "fighter",
    description: "F-16 operations",
  },
  {
    pattern: "^RAPTOR",
    operator: "usaf",
    aircraftType: "fighter",
    description: "F-22 operations",
  },
  {
    pattern: "^BONE",
    operator: "usaf",
    aircraftType: "bomber",
    description: "B-1B operations",
  },
  {
    pattern: "^DEATH",
    operator: "usaf",
    aircraftType: "bomber",
    description: "B-2 operations",
  },
  {
    pattern: "^DOOM",
    operator: "usaf",
    aircraftType: "bomber",
    description: "B-52 operations",
  },
  {
    pattern: "^SNTRY",
    operator: "usaf",
    aircraftType: "awacs",
    description: "E-3 AWACS",
  },
  {
    pattern: "^DRAGN",
    operator: "usaf",
  ...
  },
  {
    ...
    operator: "usn",
    aircraftType: "patrol",
    description: "P-8/P-3 operations",
  },
  {
    pattern: "^BRONCO",
    operator: "usn",
  ...
  { pattern: "^MARINE", operator: "usmc", description: "USMC aircraft" },
  {
    ...
    operator: "usmc",
    aircraftType: "vip",
    description: "Marine One squadron",
  },
  {
    pattern: "^NIGHT",
    operator: "usmc",
...
export const NATO_ALLIED_CALLSIGNS: CallsignPattern[] = [
  ...
  },
  {
    ...
    operator: "raf",
    aircraftType: "tanker",
    description: "RAF tanker",
  },
  {
    pattern: "^NATO",
    operator: "nato",
    aircraftType: "awacs",
    description: "NATO AWACS",
  },
  ...
  },
  {
    pattern: "^JASDF",
    operator: "other",
    description: "Japan Air Self-Defense Force",
  },
  ...
  // Australia
  {
    pattern: "^RAAF",
    operator: "other",
    description: "Royal Australian Air Force",
  },
...
export const ADVERSARY_CALLSIGNS: CallsignPattern[] = [
  // Russian Aerospace Forces
  {
    pattern: "^RF",
    operator: "vks",
    description: "Russian Federation aircraft",
  },
 ...
 */
export const MILITARY_AIRCRAFT_TYPES: Record<
  string,
  { type: MilitaryAircraftType; name: string }
> = {
  // Fighters
...
export function getNearbyHotspot(
  ...
  for (const hotspot of MILITARY_HOTSPOTS) {
    const distance = Math.sqrt(
      Math.pow(lat - hotspot.lat, 2) + Math.pow(lon - hotspot.lon, 2),
    );
