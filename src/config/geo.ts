...
export const INTEL_HOTSPOTS: Hotspot[] = [
  ...
  },
  {
    ...
    description:
      "Gang violence, government collapse, international security mission.",
    status: "Monitoring",
    escalationScore: 4,
  ...
  },
  {
    ...
    description:
      "Resurgent piracy, Al-Shabaab activity, Ethiopia-Somaliland port dispute.",
    status: "Monitoring",
    escalationScore: 4,
    escalationTrend: "escalating",
    escalationIndicators: [
  ...
  },
  {
    ...
    description:
      "US government and military headquarters. Intelligence community center.",
    status: "Monitoring",
  },
  {
    id: "silicon_valley",
    ...
    description:
      "Global tech center. AI development hub. Major economic indicator.",
    status: "Monitoring",
  },
  {
    id: "wall_street",
  ...
  },
  {
    ...
    whyItMatters:
      "Nuclear power at war; energy leverage over Europe; global order revisionism",
  },
  {
    id: "beijing",
    name: "Beijing",
    ...
    history: {
      ...
      precedentCount: 3,
      precedentDescription:
        "Tiananmen 1989, Hong Kong crackdown 2020, COVID lockdowns 2022",
      cyclicalRisk:
        "Party Congress (every 5 years), Tiananmen anniversary (June 4)",
    },
    whyItMatters:
  ...
  },
  {
    ...
    history: {
      ...
      precedentCount: 3,
      precedentDescription:
        "1954-55 Strait Crisis, 1995-96 missile crisis, 2022 exercises",
  ...
  },
  {
    ...
    description:
      "Military operations. Regional security. Intelligence activities.",
    status: "Monitoring",
    escalationScore: 5,
    escalationTrend: "stable",
    escalationIndicators: [
    ...
    history: {
      ...
      precedentCount: 5,
      precedentDescription:
        "1948 War, 1967 Six-Day War, 1973 Yom Kippur, Lebanon 2006, Gaza wars",
  ...
  },
  {
    ...
    description:
      "Arctic strategic territory. US military presence, sovereignty questions.",
    status: "Monitoring",
  },
  // Middle East hotspots
  {
    ...
    description:
      "Saudi Arabia power center. OPEC+ decisions. Regional influence.",
    status: "Monitoring",
  },
  {
    id: "cairo",
  ...
  },
  {
    ...
    description:
      "Iraqi government. Iran-backed militias. US military presence.",
    status: "Monitoring",
  },
  {
    id: "damascus",
  ...
  },
  {
    ...
    description:
      "Lebanon crisis. Hezbollah stronghold. Israel border tensions.",
    status: "Monitoring",
  },
  {
    id: "sanaa",
    ...
    history: {
      ...
      precedentCount: 3,
      precedentDescription:
        "Civil war since 2014, Saudi intervention 2015, US strikes 2024",
...
export const STRATEGIC_WATERWAYS: StrategicWaterway[] = [
  ...
  },
  {
    ...
    lat: 30.5,
    lon: 32.3,
    description: "Europe-Asia shipping",
  },
  {
    id: "panama",
    name: "PANAMA CANAL",
  ...
  },
  {
    ...
    lat: 40.2,
    lon: 26.4,
    description: "Aegean-Marmara link, Turkey control",
  },
];
...
export const CONFLICT_ZONES: ConflictZone[] = [
  ...
  },
  {
    ...
    description:
      "Power struggle between SAF and RSF paramilitary. Fighting centered around Khartoum, Darfur. Major humanitarian catastrophe with famine conditions.",
    keyDevelopments: [
      "Khartoum battle",
      "Darfur massacres",
      "El Fasher siege",
...
export const SANCTIONED_COUNTRIES: Record<
  number,
