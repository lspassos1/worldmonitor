...
export const DEFAULT_PANELS =
  SITE_VARIANT === "tech" ? TECH_PANELS : FULL_PANELS;
export const DEFAULT_MAP_LAYERS =
  SITE_VARIANT === "tech" ? TECH_MAP_LAYERS : FULL_MAP_LAYERS;
export const MOBILE_DEFAULT_MAP_LAYERS =
  SITE_VARIANT === "tech" ? TECH_MOBILE_MAP_LAYERS : FULL_MOBILE_MAP_LAYERS;
